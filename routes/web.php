...
Route::get('/admin/productList',[App\Http\Controllers\AdminDashboardController::class,'productList'])
    ->name('admin.productList');
Route::get('/admin/orders',[App\Http\Controllers\AdminDashboardController::class,'orders'])
    ->name('admin.orders');
Route::get('/admin/userList',[App\Http\Controllers\AdminDashboardController::class,'userList'])
    ->name('admin.userList');
//--- Home
...
Route::delete('/cart/{id}', [App\Http\Controllers\CartController::class,'deleteItem'])
    ->name('delete.item');
Route::patch('/cart', [App\Http\Controllers\CartController::class,'editItem'])
    ->name('edit.item');
...
Route::delete('/user/{email}', [App\Http\Controllers\AdminDashboardController::class,'deleteUser'])
    ->name('delete.user');
Route::get('/order/{id}',[App\Http\Controllers\PaymentController::class,'getOrders']);
